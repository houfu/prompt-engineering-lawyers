...
class Profile(SQLModel, table=True):
    id: UUID = Field(default=None, primary_key=True, foreign_key="auth.users.id", nullable=False, ondelete="CASCADE")
...
class Page(SQLModel, table=True):
    ...
    locked: bool = Field(default=False, description="Whether being a user is needed to view the page")
...
class UserEvent(SQLModel, table=True):
    ...
    page: Optional[int] = Field(default=None, description="If applicable, a page to which this applies to.",
                                foreign_key="page.id")
    time: datetime
